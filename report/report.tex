...
\usepackage{utdiss3-05}  		% Dissertation package style file.
...
\title{Writing a Master's Report with \LaTeX{} at
		the University of Texas at Austin}
                                                    % Required
...
\index{Abstract}%
\indent
This document has the form of a ``fake'' master's report 
...
This document and its source file show to write a Master's Report using \LaTeX{} and the
utdiss3 package. 
...
\bibliography{report}        % is inserted.			     %
