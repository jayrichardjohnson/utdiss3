...
% updated 25 Feb 2019 jrj - previous degrees are no longer required after the 
% name
...
This document and its source file show to write a Doctoral Dissertation using \LaTeX{} and the
utdiss3 package. 

It includes updates written by Jay Johnson in 2019 to meet new guidelines by the Graduate School
and make adjustments based on changes to the TeX live distribution.
...
% dissertation).
%
\include{content/chapter-introduction}

\include{content/chapter-instructions}

\include{content/chapter-howtouse}

\include{content/chapter-makingbib}

\include{content/chapter-tables+figs}

\include{content/chapter-math}
...
\include{content/chapter-appendix1}

\include{content/chapter-appendix2}

\include{content/chapter-appendix3}
...
% Generate the index.						     %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       Note: pdflatex won't put in the index,
%       and I am not sure why. If you want an
%       index, use the Makediss program to
%       generate it with Latex instead of
%       pdflatex
%	
...
Jay Johnson was also born in Minnesota but much after Craig. He wanted to help his friends out
    with their dissertation templates so he added a little to Craig's original template.
