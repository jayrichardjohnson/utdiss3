...
\author{Jay Richard Johnson}  	% Required

\address{204 E. Dean Keeton St.\\ Austin, Texas 78712}  % Required

\title{Writing a Master's Thesis with \LaTeX{} at
		the University of Texas at Austin}
                                                    % Required
...
Dedicated to my fellow UT graduate students.
\end{dedication}


\begin{acknowledgments}		% Optional
\index{Acknowledgments@\emph{Acknowledgments}}%
    This template was made by Craig William McCluskey. I've only made minor adjustments.
    He thanks the multitudes of people who helped him.
\end{acknowledgments}
...
\index{Abstract}%
\indent
This document has the form of a ``fake'' masters thesis 
...
This document and its source file show to write a Masters thesis using \LaTeX{} and the
utdiss3 package. 
